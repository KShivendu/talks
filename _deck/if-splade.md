...
<iframe :src="chart('quality-latency')" class="w-full border-0 mt-3" style="height: 370px"
...
<iframe :src="chart('latency-split')" class="w-full border-0 mt-3" style="height: 376px"
...
<iframe :src="chart('spread')" class="w-full border-0 mt-3" style="height: 384px"
...
<iframe :src="chart('ndcg-tail')" class="w-full border-0 mt-3" style="height: 420px"
