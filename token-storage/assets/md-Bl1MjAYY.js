import{o as c,V as l,a3 as h,b as o,z as u,ax as d,ay as m,G as s}from"./modules/vue-Bhcaf6WO.js";import{I as p}from"./slidev/default-LhATU_pO.js";import{u as x,f}from"./slidev/context-DWJeXq-x.js";import{u as g}from"./slidev/useDarkMode-DdaygJYo.js";import"./index-BsfsTW5f.js";import"./modules/shiki-Dq2beWmg.js";const w=["src"],C={__name:"token-storage.md__slidev_12",setup(k){const{$clicksContext:a,$frontmatter:r}=x();a.setup();const{isDark:n}=g(),i=t=>`/token-storage/charts/${t}.html${n.value?"?dark":""}`;return(t,e)=>(c(),l(p,d(m(s(f)(s(r),11))),{default:h(()=>[e[0]||(e[0]=o("h2",null,"And what does that compression cost to write?",-1)),o("iframe",{src:i("chunk-encode"),class:"w-full border-0",style:{height:"400px"},title:"Encode cost across chunk sizes"},null,8,w),u(`
