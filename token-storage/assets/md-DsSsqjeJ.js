import{_ as m}from"./slidev/VClicks-CjasPSLu.js";import{o as h,V as c,a3 as a,b as t,a2 as p,a4 as n,z as k,ax as g,ay as f,G as o}from"./modules/vue-CoOMDy5m.js";import{I as _}from"./slidev/default-CeNhx9LZ.js";import{u as w,f as y}from"./slidev/context-C-n4SQjw.js";import{u as z}from"./slidev/useDarkMode-C0GjNBmN.js";import"./index-ZaDE5Y49.js";import"./modules/shiki-DCH9zjuJ.js";const x=["src"],V={__name:"token-storage.md__slidev_16",setup(b){const{$clicksContext:r,$frontmatter:i}=w();r.setup();const{isDark:l}=z(),u=s=>`/token-storage/charts/${s}.html${l.value?"?dark":""}`;return(s,e)=>{const d=m;return h(),c(_,g(f(o(y)(o(i),15))),{default:a(()=>[e[1]||(e[1]=t("h2",null,"Agent writes",-1)),t("iframe",{src:u("agent-write"),class:"w-full border-0",style:{height:"400px"},title:"Agent and human write latency"},null,8,x),p(d,null,{default:a(()=>[...e[0]||(e[0]=[t("ul",null,[t("li",null,[n("The model "),t("strong",null,"already produced the IDs"),n(".")]),t("li",null,"A byte store throws them away, detokenizes (50.3us), then compresses")],-1)])]),_:1}),k(`
